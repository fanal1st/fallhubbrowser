...
namespace WebOS.FallHub
{
    ...
    class ExtendedWebBrowser : System.Windows.Forms.WebBrowser
    {
        ...
        public event EventHandler<STAChangeEventArgs> ExTitleChanged;
        /// <summary>
        /// text changed event trigger
        /// </summary>
        /// <param name="e"></param>
        protected void OnExTitleChange(STAChangeEventArgs e)
        {
            if (ExTitleChanged != null)
            {
                ExTitleChanged(this, e);
            }
        }
        ...
        class WebBrowserExtendedEvents : UnsafeNativeMethods.DWebBrowserEvents2
        {
            ...
            {
                _Browser.OnExTitleChange(new STAChangeEventArgs(text, BrowSTACommand.StatusChanged  ));
            }
            ...
            {
                _Browser.OnExTitleChange(new STAChangeEventArgs(text, BrowSTACommand.TitleChanged ));
            }
