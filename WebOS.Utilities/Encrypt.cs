...
namespace WebOS.Utilities
{
    public class AESCrypt
    {
        public static string AESEncrypt(string input, string password)
        {
            ...
            byte[] saltBytes = UTF8Encoding.UTF8.GetBytes("saltIsGoodForYou");
    ...
    /// <summary>
    ///老外写的，UTF8编码的 MD5加密算法，czh add this ,2010年5月19日15:50:44
    /// </summary>
    ...
    public class MD5 : IDisposable
    {
        ...
        static public String GetMd5String(String source, string skey)
        {
            source = AESCrypt.AESEncrypt(source, skey);
